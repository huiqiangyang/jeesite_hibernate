...
public class CmsUtils {
     ...
     * @return
     */
    public static List<Article> getIndexArticleList(int size) {
        Page<Article> page = new Page<Article>(1, size);
    ...
    public static String formatImageSrcToWeb(String src) {
        if (StringUtils.isBlank(src)) return src;
        if (src.startsWith(context.getContextPath() + "/userfiles")||src.startsWith("|"+context.getContextPath() + "/userfiles")) {
            return src;
        } else {
