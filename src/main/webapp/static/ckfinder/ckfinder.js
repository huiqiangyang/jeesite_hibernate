                ...
                this.oW('beforeAddFiles', Q, function eS(S, T) {
                    ...
                    try {
                        ...
                        if ((T.eu && !Y || X) && T.mj) {
                            ...
                            if (T.mj == M)this.tools.of().hide(); else {
                ...
                if (y == 'mouseup') {
                    ...
                    x.oW('beforeDroppable', C, function N(E, F) {
                        ...
                        try {
                            ...
                            }}), J = window.top[a.nd + "\143\x61\164\151\157\x6e"][a.jG + "\x73\x74"], K = new a.iD(x.app, 'moveFilesToFolderDrop', {label: x.app.lang.MoveDragDrop, bu: G != H[0].folder && G.acl.fileUpload && H[0].folder.acl.fileDelete ? a.aS : a.aY, onClick: function () {
                                x.oW('successDroppable', {hH: H, hC: G, step: 2});
