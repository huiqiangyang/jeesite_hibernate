    ...
    var a = function (b, c) {
        ...
        var p = function (B, C) {
            ...
            if (C == 'check') {
                if (!B.userlockRatio && D.getCustomData('isReady') == 'true') {
                    ...
                    B.lockRatio = false;
                    if (!E && !F)B.lockRatio = true; else if (!isNaN(G) && !isNaN(H))if (Math.round(G) == Math.round(H))B.lockRatio = true;
                }
            } else if (C != undefined)B.lockRatio = C; else {
                B.userlockRatio = 1;
                B.lockRatio = !B.lockRatio;
            }
            var I = CKEDITOR.document.getById(w);
            if (B.lockRatio)I.removeClass('cke_btn_unlocked'); else I.addClass('cke_btn_unlocked');
        ...
        return{title: b.lang.image[c == 'image' ? 'title' : 'titleButton'], minWidth: 420, minHeight: 360, onShow: function () {
            ...
            if (E) {
                ...
                if (F.count() == 1) {
                    ...
                    if (G == 'img' || G == 'input') {
                        ...
                        if (H.imageElement.getName() == 'img')H.imageEditMode = 'img'; else if (H.imageElement.getName() == 'input')H.imageEditMode = 'input';
                    }
                }
            ...
            if (C.imageEditMode) {
                ...
                if (c == 'image')C.imageElement = b.document.createElement('img'); else {
                    C.imageElement = b.document.createElement('input');
            ...
            {id: 'info', label: b.lang.image.infoTab, accessKey: 'I', elements: [
                ...
                {id: 'txtAlt', type: 'text', label: b.lang.image.alt, accessKey: 'T', 'default': '', onChange: function () {
                    ...
                    } else if (B == f)C.setAttribute('alt', D.getValue()); else if (B == g)C.removeAttribute('alt');
                }},
                {type: 'hbox', children: [
                    {id: 'basic', type: 'vbox', children: [
                        {type: 'hbox', widths: ['50%', '50%'], children: [
                            {type: 'vbox', padding: 1, children: [
                                {type: 'text', width: '40px', id: 'txtWidth', label: b.lang.common.width, onKeyUp: k, onChange: function () {
                                    ...
                                    var E = this.getValue();
                                    if (B == d) {
                                        if (E)C.setStyle('width', CKEDITOR.tools.cssLength(E)); else C.removeStyle('width');
                                ...
                                {type: 'text', id: 'txtHeight', width: '40px', label: b.lang.common.height, onKeyUp: k, onChange: function () {
                                    ...
                                    var E = this.getValue();
                                    if (B == d) {
                                        if (E)C.setStyle('height', CKEDITOR.tools.cssLength(E)); else C.removeStyle('height');
                        ...
                        {type: 'vbox', padding: 1, children: [
                            ...
                            {id: 'cmbAlign', type: 'select', widths: ['35%', '65%'], style: 'width:90px', label: b.lang.common.align, 'default': '', items: [
                                ...
                                var E = this.getValue();
                                if (B == d || B == f) {
                                    if (E)C.setStyle('float', E); else C.removeStyle('float');
                                    if (!D && B == d) {
            ...
            {id: 'Link', label: b.lang.link.title, padding: 0, elements: [
                {id: 'txtUrl', type: 'text', label: b.lang.common.url, style: 'width: 100%', 'default': '', setup: function (B, C) {
                    if (B == e) {
            ...
            {id: 'advanced', label: b.lang.common.advancedTab, elements: [
                {type: 'hbox', widths: ['50%', '25%', '25%'], children: [
                    {type: 'text', id: 'linkId', label: b.lang.common.id, setup: function (B, C) {
                ...
                {type: 'hbox', widths: ['50%', '50%'], children: [
                    {type: 'text', id: 'txtGenClass', label: b.lang.common.cssClass, 'default': '', setup: function (B, C) {
                    ...
                    {type: 'text', id: 'txtGenTitle', label: b.lang.common.advisoryTitle, 'default': '', onChange: function () {
                        ...
                        } else if (B == f)C.setAttribute('title', D.getValue()); else if (B == g)C.removeAttribute('title');
                    }}
                ]},
