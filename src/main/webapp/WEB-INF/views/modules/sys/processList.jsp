...
<table class="table table-striped table-bordered ">
    ...
    <c:forEach items="${objects }" var="object">
        ...
        <tr>
            ...
            <td><a target="_blank"
                   href='${ctx }/sys/workflow/resource/deployment?deploymentId=${process.deploymentId}&resourceName=${process.resourceName }'>${process.resourceName }</a>
            </td>
            <td><a target="_blank"
                   href='${ctx }/sys/workflow/resource/deployment?deploymentId=${process.deploymentId}&resourceName=${process.diagramResourceName }'>${process.diagramResourceName }</a>
            </td>
