...
<form:form id="searchForm" modelAttribute="product" action="${ctx}/email/list" method="post"
    ...
    <label>主题 ：</label>
    <input type="text"  htmlEscape="false" maxlength="60" class="input-search" name="title"/>
    <label>开始时间：</label>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="recMail">
        <tr>
            ...
            <td>${recMail.title}</td>
            <td>${recMail.createDate}</td>
            <td>
                <a href="${ctx}/factory/product/show?id=${recMail.id}">查看</a>
